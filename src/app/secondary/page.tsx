...
export default function SecondaryPage() {
  const { data, loading, error, month, setMonth, updateReading, updateExtraMeter } = useHouseData("secondary");
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-foreground">🏢 Secondary House</h1>
          <p className="text-sm text-muted-foreground mt-0.5">
            {data.separate.length + data.shared.reduce((s, g) => s + g.rooms.length, 0)} rooms
