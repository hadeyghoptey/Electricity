...
export default function PrimaryPage() {
  const { data, loading, error, month, setMonth, updateReading, updateExtraMeter } = useHouseData("primary");
  ...
  // Evenly update all rooms in a shared group
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <h1 className="text-xl md:text-2xl font-bold text-foreground">🏠 Primary House</h1>
